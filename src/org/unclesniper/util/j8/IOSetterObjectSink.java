...
public class IOSetterObjectSink<BaseT, PropertyT> implements IOObjectSink<PropertyT> {

	private BaseT base;

	private IOObjectSetter<? super BaseT, ? super PropertyT> setter;

	public IOSetterObjectSink(BaseT base, IOObjectSetter<? super BaseT, ? super PropertyT> setter) {
		this.base = base;
		this.setter = setter;
	}
